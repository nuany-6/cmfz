...
public class Kindeditor {
    ...
    public Map<String,Object> upload(MultipartFile img, HttpServletRequest request) throws IOException {
        ...
        String url=scheme+"://"+hostAddress+":"+port+path+"/img/"+newName;
        map.put("error",0);
        map.put("url",url);
        return map;
    }
    ...
    public Map<String,Object> all(HttpSession session, HttpServletRequest request) throws UnknownHostException, UnknownHostException {
